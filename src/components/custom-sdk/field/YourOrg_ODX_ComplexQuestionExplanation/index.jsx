...
import StyledYourOrgOdxComplexQuestionExplanationWrapper from './styles';
...
const YourOrgOdxComplexQuestionExplanation = props => {
  const {
    getPConnect,
    value,
    hideLabel,
 ...
 // BUG-547602: Temporary type coercion for 8.5 until DXAPIs are enhanced to pass original pxViewMetadata JSON, respecting boolean primitives
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledYourOrgOdxComplexQuestionExplanationWrapper>
      displayComp
      </StyledYourOrgOdxComplexQuestionExplanationWrapper>
    ) : (
      <StyledYourOrgOdxComplexQuestionExplanationWrapper>
...
YourOrgOdxComplexQuestionExplanation.defaultProps = {
  value: '',
  placeholder: '',
  validatemessage: '',
  helperText: '',
...
YourOrgOdxComplexQuestionExplanation.propTypes = {
...
export default YourOrgOdxComplexQuestionExplanation;
