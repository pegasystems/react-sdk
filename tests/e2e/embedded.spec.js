...
test.describe("E2E test", () => {
  test("should launch, select a service plan and fill details", async ({ page }) => {
    ...
    const silverPlan = await page.locator('button:has-text("shop now") >> nth=1');
    ...
    const dataServiceBeginDate = await page.locator('div[data-test-id="1321FA74451B96BC02663B0EF96CCBB9"]');
    const dataServiceBeginDateInput = await dataServiceBeginDate.locator('input');
