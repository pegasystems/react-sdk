...
class ConfigAccess {
  ...
  fixupConfigSettings() {
    ...
    if( !oServerConfig.excludePortals ) {
      ...
      console.warn(`No exludePortals server config entry found.  Using the following default list: ["pxExpress", "Developer", "pxPredictionStudio", "pxAdminStudio", "pyCaseWorker", "pyCaseManager7"]`);
    }
  }
