    ...
    if (sButtonType === 'secondary') {
      switch (sAction) {
        ...
        case 'saveAssignment': {
          ...
          savePromise
            .then(() => {
              const caseType = (thePConn.getCaseInfo() as any).c11nEnv.getValue(PCore.getConstants().CASE_INFO.CASE_TYPE_ID);
      ...
      {bHasNavigation ? (
        <>
          ...
          <Snackbar
            ...
            action={
              <IconButton size='small' aria-label='close' color='inherit' onClick={event => handleSnackbarClose(event, 'clickaway')}>
