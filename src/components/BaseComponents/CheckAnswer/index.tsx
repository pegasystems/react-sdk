...
export default function GDSCheckAnswers(props: HmrcOdxTestProps) {
  ...
  const { label, value, name, stepId, hiddenText, getPConnect, placeholder, helperText, emptyValue } = props;
  const [formattedValue, setFormattedValue] = useState<string | string[]>(value as any);
